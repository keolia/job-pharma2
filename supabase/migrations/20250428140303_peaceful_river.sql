/*
  ...
  1. Configuration
    - Configuration de Resend comme service SMTP
    - Désactivation temporaire de la confirmation email pour les tests
    - Configuration des URLs de redirection

  2. Sécurité
    - Mise à jour des politiques de sécurité pour les profils
...
UPDATE auth.config SET
  ...
  smtp_port = 465,
  smtp_user = 'resend',
  smtp_pass = 're_123456789', -- Remplacez par votre clé API Resend
